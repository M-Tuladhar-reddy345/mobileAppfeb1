                  ...
                  print(snapshot.data == []);
                        ...
                        Expanded(child: Align(
                                                    ...
                                                    child: Container(
                                                      height: 50,
                                                      child: ButtonBar(
                                                        children: [FlatButton(minWidth: (MediaQuery.of(context).size.width - 100 )/2,onPressed: ()=>cancelDay(valueDict['subType'], valueDict['quantity'].toString(), valueDict['endDate'].toString(), valueDict['subscrid'].toString()), child: Text('Cancel a Date',style: Theme.of(context).primaryTextTheme.titleSmall,)),VerticalDivider(thickness: 2,),FlatButton(minWidth: (MediaQuery.of(context).size.width - 100 )/2,onPressed: valueDict['subType'] == 'Custom'? null: ()=>editSubscriptions_dialog(valueDict['subType'], valueDict['quantity'].toString(), valueDict['endDate'].toString(), valueDict['subscrid'].toString()), child: Text('Edit',style: Theme.of(context).primaryTextTheme.titleSmall,)) ],
                                                      ),
                                                    ),
                                                  ))
                                                ],
